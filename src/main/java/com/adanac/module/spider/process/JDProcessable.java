package com.adanac.module.spider.process;
...
import com.adanac.module.spider.utils.HtmlUtils;
...
public class JDProcessable implements Processable {
	...
	private void processProduct(Page page, TagNode rootNode) {
		try {
			...
			// 获取图片地址
			page.addField("pic_url",
					"http:" + HtmlUtils.getAttributeByAttr(rootNode, "//*[@id=\"spec-n1\"]/img", "src"));
