package com.adanac.module.spider;
...
import com.adanac.module.spider.download.Downloadable;
import com.adanac.module.spider.download.HttpClientDownable;
import com.adanac.module.spider.process.JDProcessable;
import com.adanac.module.spider.process.Processable;
import com.adanac.module.spider.reposity.QueueRepository;
import com.adanac.module.spider.reposity.RedisRepository;
import com.adanac.module.spider.reposity.Repository;
import com.adanac.module.spider.store.ConsoleStoreable;
import com.adanac.module.spider.store.HBaseStoreable;
import com.adanac.module.spider.store.Storeable;
import com.adanac.module.spider.utils.Config;
import com.adanac.module.spider.utils.SleepUtils;
...
public class Spider {
	...
	public Spider() {
		String connectString = "192.168.1.173:2181";
		...
		try {
			...
			String forPath = client.create().creatingParentsIfNeeded()// 如果父节点不存在，则创建
